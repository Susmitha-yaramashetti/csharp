...
namespace cSharpLambdatest
{
    ...
    public class TestClass
    {
        ...
        public void init()
        {
            String username = "ysusmithavarma";
            String accesskey = "wTgkFE1AMEscCTyKEluQ8IwKhcuLyogcOz77vYO0SVi2k3NVgW";
            ...
            capabilities.SetCapability("name", "Selenium");
            capabilities.SetCapability("build", "CSharp");

            driver = new RemoteWebDriver(new Uri("https://ysusmithavarma:wTgkFE1AMEscCTyKEluQ8IwKhcuLyogcOz77vYO0SVi2k3NVgW@hub.lambdatest.com/wd/hub"), capabilities, TimeSpan.FromSeconds(600));
        ...
        public void input_Demo()
        {
            ...
            driver.FindElement(By.Id("name")).SendKeys("noothan");
            driver.FindElement(By.Id("inputEmail4")).SendKeys("noothan@gmail.com");
